...
const projectList: ProjectProps[] = [
  {
    ...
    desc: "A redeveloped version of my undergraduate thesis project, this solution aims to facilitate pet carrier rentals and enhance services within the pet industry.",
    logo: "/pcrms-logo.png",
    tech: [
      "TypeScript",
      "React",
